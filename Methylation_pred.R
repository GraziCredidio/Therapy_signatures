...
folder <- "Output_files/Methylation/pred"
...
transcriptome_info_file <- read.table("Cleaned_tables/models/pred/EZECohort_coldata_pred.txt", sep = "\t")
...
write.table(gene_meth_site_correlation, file = "Output_files/Methylation/pred/pred_DEG_meth_site_correlation_5000bp_1000rep.txt", 
            quote = FALSE, sep = '\t')
...
write.table(sig_gene_meth_site_correlation, file = "Output_files/Methylation/pred/pred_significant_DEG_meth_site_correlation_5000bp_1000rep.txt", 
            quote = FALSE, sep = '\t')