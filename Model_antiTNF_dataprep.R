...
write.table(ord.coldata_inactive, "Cleaned_tables/models/antiTNF/EZECohort_coldata_antiTNF.txt", sep = "\t", row.names = TRUE)
...
write.table(df_normalized_counts, "Cleaned_tables/models/antiTNF/normalized_counts_antiTNF_allPatients.txt", sep = "\t",  quote = FALSE)

vst_counts <- vst(dds_counts, blind=TRUE) 
vst_counts <- assay(vst_counts)
write.table(vst_counts, "Cleaned_tables/models/antiTNF/vst_counts_antiTNF_allPatients.txt", sep = "\t",  quote = FALSE)
...
write.table(df_normalized_counts_inactive, "Cleaned_tables/models/antiTNF/normalized_counts_antiTNF.txt", sep = "\t",  quote = FALSE)

vst_counts_inactive <- vst(dds_counts_inactive, blind=TRUE) 
vst_counts_inactive <- assay(vst_counts_inactive)
write.table(vst_counts_inactive, "Cleaned_tables/models/antiTNF/vst_counts_antiTNF.txt", sep = "\t",  quote = FALSE)