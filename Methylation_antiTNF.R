...
folder <- "Output_files/Methylation/antiTNF"
...
transcriptome_info_file <- read.table("Cleaned_tables/models/antiTNF/EZECohort_coldata_antiTNF.txt", sep = "\t")
...
gene_meth_sites <- subset(gene_meth_sites, gene_meth_sites$Chr != 'chrX' & 
                            gene_meth_sites$Chr != 'chrY' & 
